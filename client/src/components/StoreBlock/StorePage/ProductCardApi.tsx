...
import { $host, addProductToCart, check, getDecodedToken } from "../../../helpers/functions";
...
// const mapDispatchToProps = (dispatch: ThunkDispatch<any, never, gameAction>) => {
const mapDispatchToProps = (dispatch: any) => {
    return {
        deleteProduct: async (id: number, getShowCaseData: any) => {
...
const ProductCardApi = (store: any) => {
        ...
        <Card className={classes.root}>
            ...
            <CardHeader
                ...
                subheader={
                    <Typography color="textSecondary">
                        {types.map((type: any, index: number) => {if(type.id === game.typeId) return types[index].name})}
                    </Typography>
                }
            />
            <Typography>
            ...
            >
                ...
                <CardActions disableSpacing>
                    <IconButton
                        onClick={() => {
                            addProductToCart(game.id, game.price);
                        }}
                        aria-label="share"
                        // color={
